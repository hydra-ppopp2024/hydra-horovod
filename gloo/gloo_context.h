...
struct GlooContext {
  ...
  // std::shared_ptr<gloo::Context> second_ctx = nullptr;    
  std::shared_ptr<gloo::Context> sec_ctx = nullptr;  
  std::shared_ptr<gloo::Context> third_ctx = nullptr;  
  std::shared_ptr<gloo::Context> four_ctx = nullptr;    
  char* GLOO_SHARP_ALLREDUCE = getenv("GLOO_SHARP_ALLREDUCE");
  char* GLOO_PIPE_ALLREDUCE = getenv("GLOO_PIPE_ALLREDUCE");
private:
